...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const _AppWithDoubleBackPress(),
...
/// Wrapper to add double-back-press-to-exit functionality to the app
class _AppWithDoubleBackPress extends StatelessWidget {
  const _AppWithDoubleBackPress();
